...
version_file = path.join(path.dirname(__file__), 'convenience', 'VERSION')
...
setup(
    ...
    version=version,
    license='MIT',
    keywords = ['convenience', 'file', 'caching'],

    description='Convenience Functions for Python',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/ronrest/convenience_py',
