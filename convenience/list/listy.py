...
# ==============================================================================
def listy(l, search=""):
    """ Takes a list `l` and a search term, and returns elements in the list
        that contain that search term.
    
        If the search term is a number, then it returns the elements that match
        that value exactly.
    
        If the list is composed of numbers and you want to return the elements
        that contain some digit or sequence of digits (as opposed to matching
        the exact value), then use a search term that is a number as a string.
    ...
    Args:
        ...
        search: (string, or int, long, float)
